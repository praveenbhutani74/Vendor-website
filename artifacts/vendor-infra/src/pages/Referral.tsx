      ...
      <section className="py-20 bg-gray-50 flex-1">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            >
              <div className="w-14 h-14 bg-[#1a4fdb] rounded-2xl flex items-center justify-center text-white font-bold text-xl mb-6">
                CRP
              </div>
              <h2 className="text-2xl font-bold text-[#0c1c5e] mb-4">Client Referral Program</h2>
              ...
              <ul className="space-y-3 text-sm text-gray-700">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3">
                    <span className="text-[#1a4fdb] font-bold mt-0.5">✓</span>
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="bg-[#0c1c5e] rounded-2xl p-10 shadow-sm text-white"
            >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="mt-14 bg-blue-50 rounded-2xl p-10 border border-blue-100"
          >
            <h3 className="text-xl font-bold text-[#0c1c5e] mb-4">How It Works</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={s.step} className="flex gap-4">
                  <div className="w-10 h-10 bg-[#1a4fdb] text-white rounded-full flex items-center justify-center font-bold shrink-0">
                    {s.step}
                  </div>
                  <div>
                    <h4 className="font-semibold text-[#0c1c5e] mb-1">{s.title}</h4>
