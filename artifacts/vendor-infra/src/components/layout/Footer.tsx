...
export function Footer() {
  return (
    <footer className="bg-[#0c1c5e] text-white">
      {/* Main footer */}
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="space-y-4 md:col-span-2">
            <img
              src="https://vendorinfra.com/storage/2025/10/Logo-Blue-1.png"
              alt="Vendor Infra Logo"
              className="h-12 bg-white p-2 rounded"
            />
            <p className="text-blue-100 text-base mt-4 max-w-md leading-relaxed">
            ...
            <div className="flex gap-3 mt-6">
              <a
                ...
                className="bg-white/10 p-2.5 rounded-lg hover:bg-[#1a4fdb] transition-colors"
              >
      ...
      <div className="bg-black/30 border-t border-white/10">
        <div className="container mx-auto px-4 py-5">
          ...
          <p className="text-center text-blue-400/60 text-xs">
